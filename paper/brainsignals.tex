...
В эксперименте рассматриваются следующие модели: метод частных наименьших квадратов (PLS), отбор признаков с помощью квадратичного программирования (QPFS), метод Белсли (Belsley) и вариации этих методов.
...
\begin{equation}
	\btheta^* = \arg \min_{\btheta \in \Theta} {\bigl\| \bff(\bX, \btheta) - \bY \bigr\| }_2^2, 
