...
Таким образом, значения элементы матрицы $\Qsim = [q_{ij}]$ и вектора $\brel = [b_{i}]$ определяются как:
\begin{align}
...
Тогда значения элементов матрицы $\Qsim = [q_{ij}]$ и вектора $\brel = [b_{i}]$ определяются как:
\begin{align}
